...
void ActionMove::fall_left(bool &stop_gait)
{
    write_int(mem, CONTROL_ACTION, 21);
    write_int(mem, CONTROL_MOVING, 1);
    std::cout<<" | \e[38;5;45mCaindo para a esquerda\e[0m"<<std::endl;
    move_action(2, 0, stop_gait); 
    write_int(mem, CONTROL_MOVING, 0);
}

//========================================================================
//Caindo para a Direita-----------------------------------------------------
void ActionMove::fall_right(bool &stop_gait)
{
    write_int(mem, CONTROL_ACTION, 21);
    write_int(mem, CONTROL_MOVING, 1);
    std::cout<<" | \e[38;5;45mCaindo para a direita\e[0m"<<std::endl;
    move_action(3, 0, stop_gait); 
    write_int(mem, CONTROL_MOVING, 0);
}
//========================================================================
//Posição de defesa------------------------------------------------------
void ActionMove::defense_positon(bool &stop_gait)
{
    write_int(mem, CONTROL_ACTION, 21);
    //write_int(mem, CONTROL_MOVING, 1);
    std::cout<<" | \e[38;5;45mPosição de defesa\e[0m"<<std::endl;
    move_action(4, 0, stop_gait);
    write_int(mem, CONTROL_MOVING, 0);
}
